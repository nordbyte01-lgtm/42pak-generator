//
// EterPackManager_Vpk.cpp — FliegeV3 Profile
//
// Complete replacement for EterPackManager.cpp with native VPK support.
// Based on the original FliegeV3 EterPackManager.cpp with these additions:
//
...
//   - No EterPackPolicy_CSHybridCrypt include
//   - No DecryptPackIV
//   - ENABLE_LOCAL_FILE_LOADING conditional preserved in isExist
//   - FliegeV3's Get() logic preserved (checks c_szFileName[1] != ':')
//
...
//
// Get: Preserves FliegeV3's original search logic.
// FliegeV3 checks c_szFileName[1] != ':' before falling back to file (rejects
// absolute paths like "C:\..." from the loose-file search when in SEARCH_PACK_FIRST).
//
...
//
// isExist: Preserves FliegeV3's ENABLE_LOCAL_FILE_LOADING conditional.
// When the macro is not defined, only pack existence is checked — no
// loose file fallback. This is the default in FliegeV3 release builds.
//
...
//
// RegisterPack: Original EPK registration (unchanged from FliegeV3)
//
