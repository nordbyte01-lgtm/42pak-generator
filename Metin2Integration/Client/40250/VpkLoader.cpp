...
void CVpkPack::RegisterEntries(CEterFileDict& rkFileDict)
{
    ...
    for (int i = 0; i < static_cast<int>(m_entries.size()); ++i)
    {
        ...
        // Insert into the shared file dict. The dict stores a pointer to
        // this CVpkPack (cast to CEterPack*) and the stub index. When
        // GetFromPack calls pkPack->Get2(), it dispatches to our Get2.
