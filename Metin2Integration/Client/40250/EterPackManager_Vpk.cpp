//
// EterPackManager_Vpk.cpp
//
// Complete replacement for EterPackManager.cpp with native VPK support.
// Based on the original 40250 EterPackManager.cpp with these additions:
//
...
//   4. GetFromPack()       - Modified to check VPK entries via CEterFileDict
//   5. Destructor          - Cleans up VPK packs
//
// The VPK packs register their entries into CEterFileDict, so the existing
// GetFromPack -> m_FileDict.GetItem() -> pkPack->Get2() flow works
// transparently. CVpkPack::Get2 is dispatched via the reinterpret_cast
// stored during RegisterEntries.
//
...
//
// RegisterPack: Original EPK registration (unchanged from 40250)
//
