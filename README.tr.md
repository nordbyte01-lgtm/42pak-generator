...
- **EIX/EPK'yı VPK'ya dönüştürme** — Eski EterPack formatından tek tıkla geçiş (40250, FliegeV3 ve MartySama 5.8 varyantlarını destekler)
...
- **Metin2 C++ entegrasyonu** — 40250, FliegeV3 ve MartySama 5.8 kaynak ağaçları için hazır istemci ve sunucu yükleyici kodu
...
│   │   ├── Legacy/                  # EIX/EPK okuyucu ve dönüştürücü (40250 + FliegeV3 + MartySama 5.8)
...
│   │   ├── MartySama58/             # MartySama 5.8 için C++ entegrasyonu (Boost + HybridCrypt)
...
Farklı kaynak ağaçları için üç entegrasyon profili sağlanmaktadır:
